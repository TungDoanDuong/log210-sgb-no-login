import course_teacher_list from "../data/course_teacher.json";
import courses_list from "../data/courses.json";
import courses_students from "../data/course_student.json";
...
export class SgbController {
	...
	*/
	...
	public courses(teacher_id: number) {
		const course_ids = course_teacher_list
						   .filter(course_teacher => course_teacher.teacher_id == teacher_id)
						   .map(course => course.course_id);

		const courses = course_ids
						.map(course_id => courses_list
